...
const array = ['HELLO','Njan athe','Mass','Hii','Oiii','Smile','Love','Good morning','Good night','Gd mrng','mood','Helo','set','sad','Aarulle','Name and place','Master','Hiii','Annan','Vanakam','Umma']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
